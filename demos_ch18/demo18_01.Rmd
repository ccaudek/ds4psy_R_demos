...
proposal_distribution <- function(param) {
  ...
  # appena maggiori di 0 che valori appena minori di 1.
  res
}
```
...
Accept the proposal with a probability equal to prob_move. As a consequence, the frequency of the values in the chain will be proportional to the density of the posterior distribution. 
