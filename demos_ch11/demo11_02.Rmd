...
Per i punteggi di astenia di questo ipotetico test, poniamoci ora il problema di trovare il *valore atteso* e la *varianza*, e di assegnare un'interpretazione inuitiva a questi concetti.
